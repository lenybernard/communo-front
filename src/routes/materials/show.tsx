...
export const MaterialShow = () => {
    ...
    const [step, setStep] = useState<'initial' | 'choosePeriod' | 'validated'>(
        'initial'
    )
                ...
                <Container maxW={'7xl'} minW={'300px'}>
                            ...
                            <Flex>
                                <Zoom wrapStyle={{ width: '100%' }}>
                                    <Image
                                        ...
                                        alt={'product image'}
                                        src={
                                            material.images.edges.length > 0
                                                ? 'http://127.0.0.1:8000/images/materials/' +
                                                  material.images.edges[0].node
                                                      .imageName
                    ...
                    >
                        ...
                        <ModalContent pb={5}>
                            <ModalHeader>
                                {t(
                                    'material.show.booking.validate.success.title'
                                )}
                            </ModalHeader>
                            <ModalCloseButton />
                            <ModalBody>
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: t(
                                            'material.show.booking.validate.success.body',
                                            {
                                                user: material.owner,
                        ...
                        <Box as={'header'}>
                            ...
                            {material.pricings.collection.map((pricing) => (
                                ...
                                >
                                    {pricing.value === 0
                                        ? t(
                                              'material.show.pricing.free.' +
                                                  Math.floor(Math.random() * 9)
                                          )
                                        : t('material.show.pricing.price', {
                                              amount: pricing.value,
                                              period: t(
                                                  'material.show.pricing.period.' +
                                                      pricing.period
                                              ),
                                          }) +
                                          (pricing.circles.edges.length > 0
                                              ? ' (' +
                                                pricing.circles.edges.map(
                                                    ({ node }) => node.name
                                                ) +
                                                ')'
                                              : '')}
